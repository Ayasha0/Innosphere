colors = ['#BA75CD','#E0AE7F', '#19C1E5','#3ACB92','#C98EA2','#BA75CD','#E0AE7F', '#19C1E5','#3ACB92','#C98EA2']
...
ContentBoxes.forEach((box) => {
        box.addEventListener("mouseleave", (e) => {
                e.target.querySelector(".content").innerHTML = <div class="text">Lorem ipsum dolor sit amet consectetur.</div>
